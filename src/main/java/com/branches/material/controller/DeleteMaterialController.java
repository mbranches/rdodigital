...
import com.branches.material.service.DeleteMaterialService;
...
public class DeleteMaterialController {
    ...
    @DeleteMapping("/api/tenants/{externalTenantId}/materiais/{id}")
    @Operation(summary = "Delete material", description = "Deleta um material")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Void> execute(@PathVariable Long id, @PathVariable String externalTenantId) {
        ...
        deleteMaterialService.execute(id, externalTenantId, userTenants);
