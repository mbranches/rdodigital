...
public class UpdateMaoDeObraDeRelatorioController {
    ...
    @Operation(summary = "Update mao de obra de relatorio", description = "Atualiza uma mão de obra de relatório")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Mão de obra de relatório atualizada com sucesso"),
