...
public class DeleteEquipamentoDeRelatorioController {
    ...
    @Operation(summary = "Delete equipamento de relatorio", description = "Deleta um equipamento de relatório")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Equipamento de relatório deletado com sucesso"),
