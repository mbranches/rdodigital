...
public class DeleteModeloDeRelatorioController {
    ...
    @Operation(summary = "Delete modelo de relatorio", description = "Deleta um modelo de relatório")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Modelo de relatório deletado com sucesso"),
